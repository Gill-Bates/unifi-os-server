...
| `platforms` | `linux/amd64`, `linux/arm64`, or both | Target architectures |
...
- If only one architecture is built, architecture tags are pushed, but no multi-arch `:<version>` / `:latest` tags are published
